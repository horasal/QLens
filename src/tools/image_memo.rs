...
struct ImageMemoArgs {
    #[schemars(
        description = "SVG string, where canvas size must be 2048x2048",
    )]
    svg: String,

    #[schemars(description = "The optional uuid of the canvas, must be generated by this ImageMemo tool. Set to null to retrive an empty 2048x2048 canvas...")]
