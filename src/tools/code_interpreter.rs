...
impl Tool for JsInterpreter {
    ...
    fn description(&self) -> ToolDescription {
        ...
        **I/O & Files:**
        ...
        - **Images:** Images generated by tools are stored in the database with a UUID.
        - **Save Image:**  1. Call `save_svg(svg_string)` or `save_image(UInt8Array)`. 2. These functions return a UUID string.
...
const LOAD_SOURCE: &[LibraryConfig] = &[
    ...
    LibraryConfig {
        ...
        prompt_hint: "`d3` (D3.js). *Prefer SVG output*",
    },
    LibraryConfig {
        require_name: "plot",
        global_var: "Plot",
